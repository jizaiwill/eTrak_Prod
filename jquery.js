...
$(document).ready(function(){  
 ...
 $(document).on('change', '#trak1input', function(){  
      ...
      $(document).on('change', '#trak2input', function(){  
      var trak2 = $('#trak2input').val();    
      if(trak2 != '')  
           {        $.ajax({  
                     url:"trak2search.php",  
                     method:"POST", 
           ...
           $(document).on('change', '#trak3input', function(){  
      var trak3 = $('#trak3input').val();    
      if(trak3 != '')  
           {        $.ajax({  
                     url:"trak3search.php",  
                     method:"POST", 
   ...
   $(document).on('change', '#trak4input', function(){  
      var trak4 = $('#trak4input').val();    
      if(trak4 != '')  
           {        $.ajax({  
                     url:"trak4search.php",  
                     method:"POST", 

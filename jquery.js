...
$(document).on('change', 'input', function () {
    ...
    if (check < 1000 && check >= 900) {
        cell.html(9);
    }
    if (check < 900 && check >= 800) {
        cell.html(8);
    }
    if (check < 800 && check >= 700) {
        cell.html(7);
    }
    if (check < 700 && check >= 600) {
        cell.html(6);
    }
    if (check < 600 && check >= 500) {
        cell.html(5);
    }
    if (check < 500 && check >= 400) {
        cell.html(4);
    }
    if (check < 400 && check >= 300) {
        cell.html(3);
    }
    if (check < 300 && check >= 200) {
        cell.html(2);
    }
